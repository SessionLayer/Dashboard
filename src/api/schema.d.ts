...
export interface paths {
    ...
    "/v1/gateway-enrollment-tokens/{gatewayEnrollmentTokenId}": {
         ...
         *     and the enrollment path already refuses a consumed token. Revoking an
         *     already-used token has no effect on the identity it produced - revoking
         *     an issued Gateway identity is a Lock. Platform-RBAC gated
         *     (`gateway:enroll`) + audited.
         */
